...
renderTweets()
    document.addEventListener('click', async (e)=>{
        if(e.target.classList.contains('twt-btn')){
            ...
            const tweet = await twtResponce.json();
            ...
            if(e.target.classList.contains('tweet-del')){
                if(confirm("Are your sure to delete")){
                  ...
                  const responce = await fetch('https://twitter-backend-6yot.onrender.com/tweet/delete', {
                    method : 'POST',
                    headers: {
                      'Content-Type': 'application/json',
                  },
            ...
            if(e.target.classList.contains('tweet-edit')){
              ...
              const responce = await fetch('https://twitter-backend-6yot.onrender.com/tweet/update', {
                    method : 'POST',
                    headers: {
                      'Content-Type': 'application/json',
                  },
